...
prepare_button = tk.Button(root, text="Prepare Downloads Folder", command=handle_prepare_button_click)
...
label_instructions1 = tk.Label(root, text="1. Prepare Downloads Folder")
label_instructions2 = tk.Label(root, text="2. Download Yahoo Finance Portfolio")
label_instructions3 = tk.Label(root, text="    using the Yahoo Finance window")
label_instructions4 = tk.Label(root, text="3. Collect Data")
...
label_instructions3.grid(row=10, column=0, columnspan=1, sticky="nw", padx=30, pady=100)
label_instructions4.grid(row=10, column=0, columnspan=1, sticky="nw", padx=30, pady=125)
collect_button.grid(row=10, column=0, columnspan=1, sticky="nw", padx=30, pady=150)
